...
function RelatorioAcertoVendedor({ dados, empresa, logoBase64 }: Props) {
  ...
  return (
    <Document title={`Acerto de Vendedor — ${dados.vendedor || ''}`} author={nomeEmpresa}>
      <Page size="A4" style={s.page}>
        ...
        <View style={s.leilaoBox}>
          ...
          <View style={{ alignItems: 'flex-end' }}>
            <Text style={s.leilaoLabel}>Vendedor</Text>
            <Text style={s.leilaoData}>{dados.vendedor || '—'}</Text>
          </View>
        </View>
        ...
        <View style={s.totaisBox} wrap={false}>
          <View style={s.totaisLinha}>
            <Text style={s.totaisLabel}>Total de Entradas</Text>
            <Text style={s.totaisValor}>{fmtR(dados.totais.totalEntradas)}</Text>
          </View>
          <View style={s.totaisLinha}>
          ...
          <View style={s.totaisLinhaFinal}>
            <Text style={s.totaisLabelFinal}>Saldo Final</Text>
        ...
        <View style={s.cienciaBox} wrap={false}>
          ...
          <View style={s.assinatura}>
            ...
            <Text style={s.assinaturaNome}>{dados.vendedor || '—'}</Text>
          </View>
        </View>
...
export default RelatorioAcertoVendedor;
