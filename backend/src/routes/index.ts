...
bancoRouter.post('/vendas/relacao-compradores', venda.relacaoCompradores);
...
bancoRouter.put('/vendas/:id/compradores/:idComp', venda.atualizarComprador);
bancoRouter.put('/vendas/:id/compradores/:idComp/comissao', venda.atualizarComissaoComprador);
...
bancoRouter.put('/vendas/:id/encaminhamento', venda.atualizarEncaminhamento);
bancoRouter.put('/vendas/:id/forma-pagamento', venda.atualizarFormaPagamento);
bancoRouter.post('/vendas/:id/atualizar-info', venda.atualizarInfo);
bancoRouter.get('/clientes/:idCli/propriedades', clientePropriedade.listar);
...
bancoRouter.get('/clientes/:id/historico-legado', cliente.historicoLegado);
...
bancoRouter.get('/clientes/:id/documentos/status', upload.getStatusDocumentosCliente);
...
// Assistente IA
bancoRouter.post('/ai/chat', chatAI);
